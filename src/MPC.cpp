 ...
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    for (int t = 1; t < N; ++t) {
      ...
      // make all of the constraint value to be 0.
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  const int n_control_inputs = 2;
  size_t n_vars = n_states * N + n_control_inputs * (N-1);
  ...
  // The upper and lower limits of delta (steering angle limits)
